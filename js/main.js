...
const innColor = new Color("#ffffff");
const outColor = new Color("#9747ff");
...
// Mueve los objetos a la derecha en el eje x
galaxy.position.x += 1; // Ajusta el valor según sea necesario
universe.position.x += 1; // Ajusta el valor según sea necesario
